    ...
    <div className="fixed inset-0 bg-gray-900/85 backdrop-blur-md z-50 flex flex-col animate-in fade-in duration-200 select-none">
      ...
      <div className="h-16 bg-white border-b border-gray-200 px-3 sm:px-6 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-8 h-8 sm:w-9 sm:h-9 bg-acrobat-red text-white rounded-lg flex items-center justify-center shadow flex-shrink-0">
            <Eye className="w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div className="truncate max-w-[140px] xs:max-w-none">
            <h2 className="font-bold text-gray-800 text-sm sm:text-lg leading-tight truncate">Preview</h2>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            onClick={onClose}
            className="flex items-center gap-1 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl border border-gray-300 transition-colors"
          >
          ...
          <button
            onClick={onDownload}
            className="flex items-center gap-1.5 px-3.5 sm:px-5 py-1.5 sm:py-2 bg-acrobat-red text-white font-bold text-xs sm:text-sm rounded-xl shadow-lg hover:bg-acrobat-darkRed transition-all"
          >
